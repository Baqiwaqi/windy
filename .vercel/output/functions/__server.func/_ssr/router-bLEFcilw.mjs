...
const appCss = "/assets/styles-DO6rXJ0u.css";
...
const $$splitComponentImporter$6 = () => import("./index-DrQLIgPH.mjs").then((n) => n.i);
...
const $$splitComponentImporter$5 = () => import("./start.server-funcs-B6bcUzyI.mjs");
...
const $$splitComponentImporter$2 = () => import("./start.ssr.spa-mode-CAmebOzS.mjs");
...
const $$splitComponentImporter$1 = () => import("./start.ssr.full-ssr-CnM_6Kka.mjs");
const Route$1 = createFileRoute("/demo/start/ssr/full-ssr")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component"),
  loader: async () => await getPunkSongs()
});
const $$splitComponentImporter = () => import("./start.ssr.data-only-Cn-d8a_L.mjs");
