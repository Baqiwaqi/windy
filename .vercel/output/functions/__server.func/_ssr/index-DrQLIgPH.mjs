...
import { W as Wind, P as Plus, L as List, C as CircleDot, R as Ruler, S as Search, F as FileSpreadsheet, a as Settings, b as PanelLeft, c as Sun, M as Moon, d as ChevronDown, e as Save, f as Check, g as FolderOpen, D as Download, T as Trash2, U as Upload, h as FileDown, X, i as ChevronUp } from "../_libs/lucide-react.mjs";
...
import { R as Root2, T as Trigger, P as Portal2, C as Content2, I as Item2 } from "../_chunks/_libs/@radix-ui/react-dropdown-menu.mjs";
...
import { R as Root$1 } from "../_chunks/_libs/@radix-ui/react-separator.mjs";
import { R as Root$2, C as CollapsibleTrigger$1, a as CollapsibleContent$1 } from "../_chunks/_libs/@radix-ui/react-collapsible.mjs";
...
`;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pb-3 border-b border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { className: "text-xs font-semibold mb-1 block", children: [
        "Adressenbestand",
        " ",
      ...
      isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-primary mt-1", children: "Adressen laden..." }),
      !isLoading && uploadedAddresses.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-primary mt-1", children: [
        uploadedAddresses.length,
        " adressen geladen"
      ] }),
      !isLoading && uploadedAddresses.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "CSV van adressen_ophalen.py of formaat: adres,postcode,...,lat,lng" })
    ] }),
...
function CollapsibleSection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Collapsible, { defaultOpen, className: "group/collapsible", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarGroup, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarGroupLabel, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CollapsibleTrigger, { className: "flex w-full items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "size-4 transition-transform group-data-[state=open]/collapsible:rotate-180" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CollapsibleContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarGroupContent, { className: "px-2 pt-2", children }) })
  ] }) });
}
function AppSidebar() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Sidebar, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarHeader, { className: "px-4 py-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Wind, { className: "size-6 text-primary" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg font-bold tracking-wider text-primary", children: "WINDY" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Windturbine Visualisatie" })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarFooter, { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PdfExport, {}) })
  ] });
}
...
const MapView = reactExports.lazy(() => import("./MapView-DSDYwQuL.mjs").then((m) => ({
  default: m.MapView
})));
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarProvider, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarInset, { className: "flex flex-col h-screen overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex items-center gap-2 border-b px-4 py-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarTrigger, { className: "-ml-1" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-sm font-semibold", children: "Windturbine Visualisatie" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Hoeker en GarstenPolder" })
        ] }),
