...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CFuvnlU5.mjs");
...
const manifest = { "c9d51a5243700889c80f82ed57a4ce74b25f188e5ebd534c9c64965dc44e8e8d": {
  ...
  importer: () => import("./start.server-funcs-DJ-3TvEy.mjs")
  ...
  importer: () => import("./demo.punk-songs-DKez53OK.mjs")
} };
...
async function loadEntries() {
  const routerEntry = await import("./router-bLEFcilw.mjs").then((n) => n.r);
