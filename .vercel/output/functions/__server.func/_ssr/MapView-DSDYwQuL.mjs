...
import { b as useTurbineStore, c as useThemeStore, a as useMapStore, d as distanceZones, f as findConflicts, u as useAddressStore, t as turbineColors, e as turbineTypes } from "./index-DrQLIgPH.mjs";
...
function MapView() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(MapContainer, { center: [52.235, 5.05], zoom: 12, className: "h-full w-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      TileLayer,
      {
